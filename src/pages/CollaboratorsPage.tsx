...
const CollaboratorsPage = () => {
  ...
  const partnershipsInView = useInView(partnershipsRef, {
    once: true
  });
  ...
  const partnerships = [{
    ...
    achievements: ["First school in Mumbai to achieve carbon-neutral status", "Winner of 'Green School of the Year' award 2023", "Reduced campus energy consumption by 40%", "Established Mumbai's first student-run environmental research lab"],
    stats: [{
    ...
    achievements: ["Connected 500+ schools across 40 countries", "Facilitated 10,000+ international collaborations", "Launched virtual climate labs in 25 languages", "Created world's largest student climate database"],
    stats: [{
      label: "Schools",
      value: "500+"
    }, {
    ...
    links: [{
      ...
      url: "https://www.takeactionglobal.org/"
    }],
    ...
    achievements: ["Engaged 100,000+ students in 3 years", "Generated 500+ actionable climate solutions", "Translated materials into 30+ languages", "Created partnerships with UNESCO and UNICEF"],
    stats: [{
      label: "Participants",
      value: "100K+"
    }, {
    ...
    achievements: ["Three consecutive years of recognition (2022-2025)", "Only school in Maharashtra with this achievement", "Mentored 15 other schools to achieve certification", "Developed curriculum framework adopted by 50+ schools"],
    stats: [{
      label: "Recognition Years",
      value: "3"
    }, {
      label: "Schools Mentored",
      value: "15"
    }, {
      label: "Curriculum Reach",
      value: "50+"
    }, {
      label: "Impact Score",
      value: "A+"
    ...
    achievements: ["Mobilized 5,000+ students across India", "Organized 100+ community cleanup drives", "Planted 10,000+ trees in urban areas", "Reached 50,000+ people through awareness campaigns"],
    stats: [{
      ...
      <section ref={heroRef} className="relative py-20 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 opacity-30">
            {[...Array(50)].map((_, i) => <motion.div key={i} className="absolute w-1 h-1 bg-primary/40 rounded-full" style={{
      ...
      <section ref={partnershipsRef} className="py-20 relative">
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-12">
            {partnerships.map((partnership, index) => <motion.div key={partnership.id} initial={{
            opacity: 0,
            x: index % 2 === 0 ? -50 : 50
          }} animate={partnershipsInView ? {
            opacity: 1,
            ...
            delay: index * 0.2
                    ...
                    <div className="flex flex-col lg:flex-row">
                      ...
                      <div className="lg:w-1/3 p-8 flex items-center justify-center bg-gradient-to-br from-primary/10 to-secondary/10">
                        <div className="relative">
                          <img src={partnership.logo} alt={`${partnership.title} logo`} className="w-full max-w-[200px] h-auto object-contain group-hover:scale-110 transition-transform duration-500" />
                      ...
                      <div className="lg:w-2/3 p-8">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                          {partnership.stats.map((stat, statIndex) => <div key={statIndex} className="text-center p-3 bg-card/50 rounded-lg">
                        ...
                        <div className="flex flex-wrap gap-2 mb-6">
                          {partnership.badges.map((badge, badgeIndex) => <span key={badgeIndex} className="px-3 py-1 bg-primary/20 text-primary text-sm rounded-full border border-primary/30">
                              {badge}
                            </span>)}
                        </div>

                        {/* Links */}
                        {partnership.links && <div className="flex flex-wrap gap-3">
                            {partnership.links.map((link, linkIndex) => <Button key={linkIndex} asChild variant="outline" className="border-primary/50 text-primary hover:bg-primary hover:text-primary-foreground">
                ...
                {partnership.id === "jbcn" && <motion.div initial={{
              opacity: 0,
              scale: 0
            }} animate={partnershipsInView ? {
              opacity: 1,
              ...
              <CardContent className="p-0">
                <div className="flex flex-col">
                  ...
                  <div className="w-full relative">
                    <img src="/lovable-uploads/climate-action-certificate.jpg" alt="Climate Action Certificate" className="w-full h-auto object-contain max-h-[600px] md:max-h-[700px] lg:max-h-[800px]" loading="lazy" onError={e => {
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          duration: 0.8
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild variant="outline" size="lg" className="border-primary/50 text-primary hover:bg-primary hover:text-primary-foreground">
