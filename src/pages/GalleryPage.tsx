      ...
      <main className="min-h-screen bg-background pt-20">
        ...
        <section className="px-4 pb-20">
          <div className="container mx-auto">
            <motion.div layout className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 sm:gap-6">
              {galleryItems.map((item, index) => <motion.div key={item.id} layout initial={{
              opacity: 0,
              scale: 0.8
            }} animate={{
              opacity: 1,
              ...
              delay: index * 0.1
                  ...
                  <Card className="overflow-hidden shadow-card hover-lift cursor-pointer" onClick={() => handleItemClick(item)}>
        ...
        opacity: 0
          ...
          scale: 0.8
        }} className="max-w-4xl w-full bg-card rounded-lg overflow-hidden" onClick={e => e.stopPropagation()}>
